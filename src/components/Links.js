...
function Links() {
  return (
    ...
    >
      <p id="fuck">
        Hello!,
        <br /> This is Vishal, <br /> I'm a Web Developer.
      </p>

      {/* Social Media Icons */}
      <div className="social-icons" style={{ margin: "20px 0" }}>
        <a
          href="https://github.com/VishalGowlikar"
          target="_blank"
        ...
        <a
          href="https://www.linkedin.com/in/vishal-gowlikar-235b20204/"
          target="_blank"
          rel="noopener noreferrer"
          style={{ margin: "0 10px" }}
        >
      ...
      <div className="buttons" style={{ marginTop: "20px" }}>
        <a
          href="https://www.linkedin.com/in/vishal-gowlikar-235b20204/overlay/1729549076664/single-media-viewer/?type=DOCUMENT&profileId=ACoAADQip0kBzOZM5cM7jCgg-bxO1HCpIm2Vvpo"
          target="_blank"
          rel="noopener noreferrer"
          style={{ margin: "0 10px" }}
        >
