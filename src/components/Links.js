...
function Links() {
    return (
        <div className="Links" style={{ textAlign: 'center', padding: '20px', background: 'rgba(255, 255, 255, 0.1)', backdropFilter: 'blur(10px)', borderRadius: '8px' }}>
            ...
            <a href="https://www.linkedin.com/in/vishal-gowlikar-235b20204/overlay/1729549076664/single-media-viewer/?type=DOCUMENT&profileId=ACoAADQip0kBzOZM5cM7jCgg-bxO1HCpIm2Vvpo" target="_blank" rel="noopener noreferrer" style={{ margin: '0 10px' }}><button className=" btn-5"><span>Resume</span></button></a>
